...
$result=mysql_query ("SELECT title,meta_dec,meta_key,text FROM settings WHERE page='dream'", $db);
if (!$result)
{
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
       <? include ("blocks/lefttd.php");?> 
        <td align="left" valign="top"><p class="text_nav"><p><img src="image/dream.jpg"></p><? echo $myrow ["text"];?></p></td>
      </tr>
    </table></td>
  </tr>
